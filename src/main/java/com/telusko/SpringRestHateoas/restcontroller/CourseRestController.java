...
public class CourseRestController 
{
	...
	public ResponseEntity<Course> getCourseDetails(@PathVariable("id") Integer id)
	{
		...
		Link link = WebMvcLinkBuilder.linkTo(WebMvcLinkBuilder.methodOn(CourseRestController.class)
	...
	public List<Course> getCoursesDetails()
	{
		...
		courses.add(new Course(102, "React", 8888.9));
		courses.add(new Course(104, "DevOps with AWS", 9999.9));
		return courses;
	}
	...
	public ResponseEntity<Course> getJavaCourse(@PathVariable("id") Integer id)
	{
		...
		Course course=new Course(144, "Multithreading", 999.4);
